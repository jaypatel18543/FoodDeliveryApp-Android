...
public class DeliverySendOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entercode = findViewById(R.id.code1);
        txtt = findViewById(R.id.text2);
        resend = findViewById(R.id.resendotp1);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            startActivity(new Intent(DeliverySendOtp.this,DeliveryFoodPanel1_BottomNavigation.class));
                            finish();
