...
public class DeliveryVerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resend = findViewById(R.id.resendotpcode);
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallBack = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onCodeSent(@NonNull String verificationId, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
            ...
            DeliveryVerifyPhone.this.verificationId = verificationId;
        }
    };
    ...
    private void linkCredential(PhoneAuthCredential credential) {
        fAuth.getCurrentUser().linkWithCredential(credential).addOnCompleteListener(DeliveryVerifyPhone.this, new OnCompleteListener<AuthResult>() {
            @Override
