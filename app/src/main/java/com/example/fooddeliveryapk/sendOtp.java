...
public class sendOtp extends ComponentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneno = getIntent().getStringExtra("phonenumbeir").trim();
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            startActivity(new Intent(sendOtp.this,CustomerFoodPanel1_BottomNavigation.class));
                            finish();
